...
import org.soen387.domain.command.PlayPokemonCommand;
import org.soen387.domain.command.RetireCommand;

public class PlayPokemonDispatcher extends Dispatcher{
	...
	public void execute() throws ServletException, IOException {
		...
		PlayPokemonCommand playPokemonCommand = new PlayPokemonCommand(myHelper);
		try {
			playPokemonCommand.execute();
