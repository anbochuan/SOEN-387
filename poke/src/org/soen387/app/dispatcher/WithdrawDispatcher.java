...
import org.soen387.domain.command.WithdrawCommand;

public class WithdrawDispatcher extends Dispatcher{
	...
	public void execute() throws ServletException, IOException {
		...
		WithdrawCommand withdrawCommand = new WithdrawCommand(myHelper);
		try {
