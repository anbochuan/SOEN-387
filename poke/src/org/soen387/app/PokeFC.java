...
import org.soen387.domain.card.mapper.CardOutputMapper;
import org.soen387.domain.challenge.Challenge;
import org.soen387.domain.challenge.mapper.ChallengeOutputMapper;
import org.soen387.domain.deck.Deck;
import org.soen387.domain.deck.mapper.DeckOutputMapper;
import org.soen387.domain.game.Game;
import org.soen387.domain.game.mapper.GameOutputMapper;
...
import org.soen387.domain.user.mapper.UserOutputMapper;
...
//		if (!ApplicationAuthorizaton.hasAuthority(commandName, ((org.dsrg.soenea.domain.user.User) currentUser).getRoles(), ApplicationAuthorizaton.RequestMethod.valueOf(request.getMethod()))) {
...
//		IUser currentUser = (IUser) new GuestUser();
