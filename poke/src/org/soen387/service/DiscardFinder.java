...
public class DiscardFinder {
	...
	// select by id query
				public static String SELECT_BY_ID_SQL = "SELECT id, user_id, game_id, version FROM " + DiscardTDG.TABLE + " WHERE id=?;";
				
				// select All query
				public static String SELECT_ALL_SQL = "SELECT id, user_id, game_id, version FROM " + DiscardTDG.TABLE + ";";
